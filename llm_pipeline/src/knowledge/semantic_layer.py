"""Semantic Layer — loads business metrics, aliases, sensitive columns, enums, business rules.

Reused from Phase 1 with same interface. The semantic_layer.yaml config is shared.
"""
